...
(function (sinonChai) {
  ...
  function sinonProperty (name, action, nonNegatedSuffix) {
    utils.addProperty(chai.Assertion.prototype, name, function handler () {
  ...
  function sinonPropertyAsBooleanMethod (name, action, nonNegatedSuffix) {
    utils.addMethod(chai.Assertion.prototype, name, function handler (arg) {
      assertCanWorkWith(this)
  ...
  function createSinonMethodHandler (sinonName, action, nonNegatedSuffix) {
    return function sinonMethodHandler (...args) {
      assertCanWorkWith(this)
      ...
      const messages = getMessages(this._obj, action, nonNegatedSuffix, shouldBeAlways, slice.call(args))
      this.assert(
        this._obj[sinonMethodName].apply(this._obj, args),
  ...
  utils.addProperty(chai.Assertion.prototype, 'always', function always () {
